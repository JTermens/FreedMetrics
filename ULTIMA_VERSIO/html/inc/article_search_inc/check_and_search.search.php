...
$id_array = array(); // create an array with the source id of each article in the db
$doi_array = array(); // create an array with the doi (if any) of each article in the db
