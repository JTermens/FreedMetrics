...
CREATE TABLE IF NOT EXISTS `freedmetrics`.`Article_has_Journal` (
  ...
  INDEX `fk_Article_has_Journal_Article1_idx` (`Article_article_id` ASC),
...
CREATE TABLE IF NOT EXISTS `freedmetrics`.`Persons_has_Article` (
  ...
  PRIMARY KEY (`Persons_email`, `Article_article_id`),
  INDEX `fk_Persons_has_Article_Article1_idx` (`Article_article_id` ASC),
...
CREATE TABLE IF NOT EXISTS `freedmetrics`.`Article_has_Keywords` (
  ...
  INDEX `fk_Article_has_Keywords_Article1_idx` (`Article_article_id` ASC),
...
CREATE TABLE IF NOT EXISTS `freedmetrics`.`Article_has_Metrics` (
  `Article_article_id` VARCHAR(45) NOT NULL,
  `Metrics_idMetrics` INT NOT NULL,
  PRIMARY KEY (`Article_article_id`, `Metrics_idMetrics`),
  INDEX `fk_Article_has_Metrics_Metrics1_idx` (`Metrics_idMetrics` ASC),
  INDEX `fk_Article_has_Metrics_Article1_idx` (`Article_article_id` ASC),
