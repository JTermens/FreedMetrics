...
function results_table_db($entries,$tag){
  ...
  foreach($entries as $key => $entry) {
    ...
    $table .= "<tr>
                  <td>
                    <h5><a href=\"index.php?pagename=Article-Page&id=".$entry['article_id']."\" rel=\"noopener noreferrer\" target=\"_blank\">".$entry['title']."</a>";
